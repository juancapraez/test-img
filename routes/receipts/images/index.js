...
router.post("/receipt/image/payment", async (req, res) => {
  try {
    ...
    // Card 1: padding 16 * 1.5 top/bottom + 0 left/right = 48 + title 25 * 1.5 + margin 12 * 1.5 + 4 rows * (16 * 1.5 + gap 8 * 1.5) = 37.5 + 18 + 4 * (24 + 12) = 55.5 + 144 = 247.5
    // Divider 2: 1 + margin 16 = 17
    // Card 2: padding 16 * 1.5 top/bottom + 0 left/right = 48 + title 25 * 1.5 + margin 12 * 1.5 + 3 rows * (16 * 1.5 + gap 8 * 1.5) = 37.5 + 18 + 3 * (24 + 12) = 55.5 + 108 = 211.5
...
router.post("/receipt/image/payout", async (req, res) => {
  try {
    ...
    // Divider 2: 1 + margin 16 = 17
    // Card 2: padding 16 * 1.5 top/bottom + 0 left/right = 48 + title 25 * 1.5 + margin 12 * 1.5 + 3 rows * (16 * 1.5 + gap 8 * 1.5) = 37.5 + 18 + 3 * (24 + 12) = 55.5 + 108 = 211.5
    // Card 3 (bank info): padding 16 * 1.5 top/bottom + 0 left/right = 48 + title 25 * 1.5 + margin 12 * 1.5 + 3 rows * (16 * 1.5 + gap 8 * 1.5) = 37.5 + 18 + 3 * (24 + 12) = 55.5 + 108 = 211.5
    // Divider 3: 1 + margin 16 = 17
    // Footer with text and logo: 20 * 1.5 + margin 10 * 1.5 = 30 + 15 = 45
