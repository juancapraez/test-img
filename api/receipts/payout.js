 ...
 * Generates payout receipt images with PDF to JPG conversion
 */
...
function splitTextInTwoLines(text, maxLength = 30) {
  if (!text) return ["", ""];
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // --- Estructura del PDF ---
    const docDefinition = {
      pageSize: { width: 480, height: height },
              ...
              stack: [
                ...
                },
                {
                  columns: [
                    ...
                    {
                      text: `${bank_account_type} - ${bank_account_number}`,
                      font: "RedHatDisplay",
                      fontSize: 17,
                      color: "#222",
                      alignment: "right",
