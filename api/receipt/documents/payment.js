...
module.exports = async (req, res) => {
  ...
  try {
          ...
          stack: [
            {
              columns: [
                {
                  stack: [
                    { text: "¡Pago exitoso!", style: "h1", color: main_color_brand || "#374550" },
            ...
            {
              text: "A continuación encontrarás la información del pago completado:",
              fontSize: 12,
              margin: [0, 0, 0, 10],
            },
            {
              ...
              table: {
                ...
                body: [
                  [
                    {
                      stack: [
                        { text: "Medio de pago", style: "label" },
                        { text: safePaymentMethod, style: "value", noWrap: true },
                      ],
                    },
                    {
                      stack: [
                        { text: "Entidad", style: "label" },
                        { text: safePaymentProvider, style: "value", noWrap: true },
                      ],
                    },
                  ],
                ],
            ...
            {
              text: `Este pago fue realizado a ${merchant_name} identificado con ${merchant_id_type} ${merchant_id} usando la tecnología de Trazo. Toda la información contenida es suministrada por el comercio y el manejo de la información se da de acuerdo a nuestra política de privacidad. Este comprobante puede ser considerado un título valor según el artículo 488 del Código General del Proceso de Colombia.`,
              fontSize: 10,
              color: "#6B7280",
              alignment: "justify",
              margin: [0, 12, 0, 10],
    ...
    const fileName = `receipt-payment-${timestamp}-${hash.substring(0, 8)}.pdf`;
